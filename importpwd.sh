...
keyid=0x79D8E883 # this is you keyid for your "database" encryption key

salt="counter-rainbow-technology" # this should be some random string
...
[[ -f "${HOME}/.gpg-agent-info" ]] && {
    ...
    # TODO check if gpg-agent is indeed running
}
